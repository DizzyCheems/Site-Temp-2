...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body" style="background-image: url('/albumbg/164763-building-atmosphere-skyscraper-world-light-x750.jpg');
    background-repeat:no-repeat;   background-size: cover; " >
      <h2 class="song-titleh2">our song (outro)</h2>
      <h2 class="song-titleh2">astra cartier</h2>

<img src="/image/cover.jpg" style="width:300px; height:300px; margin-left:80px; border-radius:3px; border:solid;"  />

<!-- Audio player !-->
<audio src="/songs/5 astra cartier - our song (outro).mp3" controls 
style="margin: 0 auto; width: 550px; margin-left:400px; margin-top:30px; position:relative;
right:150px;"> </audio>  
...
<div id="song3" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body" style="background-image: url('/albumbg/riding-to-synthwave-beach-sy-2560x1440.jpg');
    background-repeat:no-repeat;   background-size: cover;" >
...
<!-- Audio player !-->
<audio src="/songs/3 astra cartier - hope.mp3" controls 
style="margin: 0 auto; width: 550px; margin-left:400px; margin-top:30px; position:relative;
right:150px;"> </audio>  
