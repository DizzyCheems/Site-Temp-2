...
<body>
  ...
  <div class="page-headingcontact">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="top-text header-text">
            <h6>Contact Us</h6>
            <h2>Submit yout Queries Here</h2>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-stretch no-gutters contact-wrap">
        <div class="col-md-8">
          <div class="form h-100">
            ...
            <form action= "{{route('submit_message')}}" class="mb-5" method="POST" name="contactForm">
              @csrf
              ...
              <div class="row">
                <div class="col-md-12 form-group mb-5">
                  ...
                  <textarea class="form-control" name="message" cols="30" rows="4"  placeholder="Write your message"></textarea>
        ...
        <div class="col-md-4">
          <div class="contact-info h-100">
            <h3>Talk to Us</h3>
            <p class="mb-5" style="font-size: 16px; color:white;">Some Uncertainties bugging your head? we will be happy to provide you answers!</p>
            <ul class="list-unstyled">
              <li class="d-flex">
                <span class="wrap-icon icon-room mr-3"></span>
                <span class="text">Koronadal City, South Cotabato</span>
              </li>
              <li class="d-flex">
                <span class="wrap-icon icon-phone mr-3"></span>
                <span class="text">+63 (291) CEO contact number</span>
              </li>
              <li class="d-flex">
                <span class="wrap-icon icon-envelope mr-3"></span>
                <span class="text">Query@Tentacit.com</span>
              </li>
            </ul>
          </div>
        </div>
